...
export class WorldTrackerDB {
    ...
    async exportChat(chatId) {
        ...
        return redactSecretFields({ chatId, locations: locs, movements: movs, distances: dists, mapConfig: cfg, exportedAt: Date.now(), version: '0.9.57-beta' });
    }
    ...
    async exportAll() {
        ...
        allData.exportedAt = Date.now(); allData.version = '0.9.57-beta';
